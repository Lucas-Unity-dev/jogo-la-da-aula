...
public class Player : MonoBehaviour
{
    ...
    // Start is called before the first frame updateUE
    void Start()
    {
    ...
    void Update()
    {
        ...
        if(Movimento!=0)
        {
            animate.SetBool("Correndinho", true);
        }
        else
        {
            animate.SetBool("Correndinho", false);
        }
    ...
    void Pulo()
    {
        if(Input.GetButton("Jump") && !TaVoando)
        {
            ...
            animate.SetBool("Pulandinho", true);
        }
    }
    ...
    void OnCollisionEnter2D(Collision2D colide)
    {
       ...
       {
           TaVoando = false;
           animate.SetBool("Pulandinho", false);
       } 
